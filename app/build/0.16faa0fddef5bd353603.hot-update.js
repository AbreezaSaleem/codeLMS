...
var hasBinary = __webpack_require__(313);
...
var yeast = __webpack_require__(318);
...
var _ConsolePageActions = __webpack_require__(55);
...
var CodeEditor = function (_React$Component) {
   ...
   console.log(this.state)
		...
		value: function runButton(event) {
			...
			socket.on('analyzeCode', function (ret) {
				console.log(ret.results);
				history.push({
					pathname: '/loginS/student/course/console/report',
					state: {
						username: _this2.props.currentUsername.currentUsername,
						course: _this2.props.activeCourse.activeCourse,
						report: ret.results
					}
				});
			});
		...
		value: function uploadButton(event) {
			...
			console.log(data);
			var courseCode = data.activeCourse.activeCourse.split('|')[0];
...
CodeEditor.propTypes = {
	...
	analyzeUserCode: _propTypes2.default.func.isRequired
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		...
		analyzeUserCode: function analyzeUserCode(socket, code) {
			return dispatch((0, _ConsolePageActions.analyzeCode)(socket, code));
		}
	};
};
...
var parser = __webpack_require__(66);
var Manager = __webpack_require__(315);
...
exports.Manager = __webpack_require__(315);
exports.Socket = __webpack_require__(320);
...
var parseuri = __webpack_require__(312);
...
var isBuf = __webpack_require__(314);
var toString = Object.prototype.toString;
var withNativeBlob = typeof global.Blob === 'function' || toString.call(global.Blob) === '[object BlobConstructor]';
var withNativeFile = typeof global.File === 'function' || toString.call(global.File) === '[object FileConstructor]';
...
var transports = __webpack_require__(316);
var Emitter = __webpack_require__(24);
var debug = __webpack_require__(42)('engine.io-client:socket');
var index = __webpack_require__(319);
var parser = __webpack_require__(25);
var parseuri = __webpack_require__(312);
var parseqs = __webpack_require__(40);
...
Socket.transports = __webpack_require__(316);
...
var XMLHttpRequest = __webpack_require__(67);
var Polling = __webpack_require__(317);
var Emitter = __webpack_require__(24);
var inherit = __webpack_require__(41);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59)(module), __webpack_require__(8)))
