...
var _ReactAce = __webpack_require__(439);
...
var _socket = __webpack_require__(462);
		...
		value: function runButton(event) {
			...
			socket.on('analyzeCode', function (ret) {
				...
				_History2.default.push({
					...
					state: {
						username: _this2.props.state.currentUsername.currentUsername,
						course: _this2.props.state.activeCourse.activeCourse,
						report: ret.results,
