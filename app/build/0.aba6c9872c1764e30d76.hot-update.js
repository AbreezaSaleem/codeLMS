...
var _CoursesActions = __webpack_require__(28);
...
var NewGradeComponent = function (_React$Component) {
    ...
    .then(response =>
    {
    	...
    	console.log(this.state.studentsEnrolled)
				...
				_this2.setState({
					studentsEnrolled: "Aynoor Saleem|16100067"
				});
			});
		}
	}, {
		...
		value: function onCreate(event) {
			...
			this.props.createRepos({ course: this.state.courseCode, students: this.state.studentsEnrolled }).then(function (response) {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ className: 'btn-custom', onCreate: this.onCreate },
					' Create! '
				)
			);
		}
