...
var _ReactAce = __webpack_require__(420);
...
var CodeEditor = function (_React$Component) {
	...
	_createClass(CodeEditor, [{
		...
		value: function render() {
			...
			if (this.state.runButtonClicked) {
				console.log("Submit Button has been clicked.");
			}
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										Button,
										{ className: 'btn btn-lg btn-success', onClick: this.runButton },
										' Run '
									),
									_react2.default.createElement(
										Button,
										{ className: 'btn btn-lg btn-success', onClick: this.submitButton },
										' Submit '
									)
								)
							),
