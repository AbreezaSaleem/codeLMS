...
var _reactCenter = __webpack_require__(35);
		...
		value: function onSubmit(event) {
			...
			if (this.state.username && this.state.password) {
				this.props.studentLoginRequest({ username: this.state.username, password: this.state.password }).then(function (response) /// ctx.body's data will be available HERE in reponse variable
				{
					...
					console.log(_this2.props.addUsername);
					_this2.props.addUsername(_this2.state.username);
					_this2.setState({
...
LoginForm.propTypes = {
	...
	addUsername: _propTypes2.default.func.isRequired
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		addUsername: function addUsername(username) {
			return dispatch((0, _LoginActions.activeUsername)(username));
		}
	};
};
