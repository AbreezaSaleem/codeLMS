   	 ...
   	 return {
   		style: {
			...
			temp.map(function (num) {
				columns.push({ id: 'Test Case ' + num, Header: 'Test Case ' + num, accessor: function accessor(d) {
						return d[num];
					} });
				columns1.push({ id: 'Test Case ' + num, Header: 'Test Case ' + num, accessor: function accessor(d) {
						return d[num];
					} });
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_reactTable2.default, { className: "-striped -highlight",
					minRows: this.state.testCasesResults.length,
					showPaginationBottom: false,
					data: this.state.testCasesResults,
					columns: columns1 })
			);
		}
	}]);
