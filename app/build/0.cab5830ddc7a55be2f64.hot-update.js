...
var _SignupActions = __webpack_require__(495);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		...
		studentSignup: function (_studentSignup) {
			function studentSignup(_x) {
				return _studentSignup.apply(this, arguments);
			}

			studentSignup.toString = function () {
				return _studentSignup.toString();
			};

			return studentSignup;
		}(function (x) {
			return dispatch(studentSignup(x));
		})
	};
};
