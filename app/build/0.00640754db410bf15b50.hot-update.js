...
var _reactTable = __webpack_require__(501);
...
var Report = function (_React$Component) {
	...
	_createClass(Report, [{
		...
		value: function render() {
			...
			var meh = this.props.state.activeAssignment.activeAssignment;
...
function mapStateToProps(state) {
	console.log(state);
	return { state: state // y me lyk dis
	};
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(Report);
