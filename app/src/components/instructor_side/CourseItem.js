...
import { getSubcomponentsNamesOnCoursePageIns } from '../../Actions/CoursePageActions'
...
({
	getSubcomponents: (courseData) => dispatch(getSubcomponentsNamesOnCoursePageIns(courseData))
});
